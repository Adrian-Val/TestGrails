    ...
    <body>
        <div class="row">
            <div class="col-md-6 d-flex justify-content-start">
                <h3>Editar tipo de actividad</h3>
            </div>
        ...
        <div id="edit-tipoActividad" class="content scaffold-edit" role="main">
            ...
            <g:form url="[resource:tipoActividadInstance, action:'update']" method="PUT" >
                <g:hiddenField name="version" value="${tipoActividadInstance?.version}" />
                <fieldset class="form">
