...
<html>
    <head>
        ...
        <title>Editar relacion de actividades</title>
    </head>
    <body>
        <div class="row">
        ...
        <div id="edit-detalleActividades" class="content scaffold-edit" role="main">
            ...
            <g:form url="[resource:detalleActividadesInstance, action:'update']" method="PUT" >
                <g:hiddenField name="version" value="${detalleActividadesInstance?.version}" />
                <fieldset class="form">
